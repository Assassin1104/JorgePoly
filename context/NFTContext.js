...
// infura ipfs option
const subdomainName = 'jorgepoly';
const projectId = '2G8GBqNku37FvgkDY9qSlkbSgUt';
const projectSecret = 'f2a19dbe723f5ca748b994c172bd579e';
...
export const NFTProvider = ({ children }) => {
  ...
  const fetchNFTs = async () => {
    ...
    const provider = new ethers.providers.JsonRpcProvider('https://polygon-mumbai.g.alchemy.com/v2/in7FYraHgU0pCFefCyv02pLLMfAYy0O8');
